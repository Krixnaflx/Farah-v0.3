...
async function createHelpContainer(categoryKey = null, botAvatarURL, userAvatarURL, clientId, guildId = null, botUsername = 'Bot') {
    ...
    if (!categoryKey) {
        ...
        const categoryList =
            ...
            `\n\n> 🔗 **[Support](${config.SUPPORT_SERVER})** • 🌐 **[Website](https://yourwebsite.com)** • ➕ **[Invite](https://discord.com/oauth2/authorize?client_id=${clientId}&permissions=8&scope=bot%20applications.commands)**`;
...
module.exports = {
    ...
    async execute(interactionOrMessage, args = []) {
        ...
        container
            .addSeparatorComponents(new SeparatorBuilder().setSpacing(SeparatorSpacingSize.Small).setDivider(true))
            .addTextDisplayComponents(
                new TextDisplayBuilder().setContent('-# Powered By Krixnaflx')
            );
